...
| ----------------------- | ----------------------- | ----------------------- | ----------------------- |
| `id`                    | *str*                   | :heavy_check_mark:      | Contact ID              |
...
| `phone_primary`         | *OptionalNullable[str]* | :heavy_minus_sign:      | Primary phone           |
| `company`               | *OptionalNullable[str]* | :heavy_minus_sign:      | Company                 |
