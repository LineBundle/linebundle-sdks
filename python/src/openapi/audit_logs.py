...
class AuditLogs(BaseSDK):
    def list_permission_audit_logs_api_v1_audit_logs_permissions_get(
        self,
        *,
    ...
    async def list_permission_audit_logs_api_v1_audit_logs_permissions_get_async(
        self,
        *,
        user_id: OptionalNullable[str] = UNSET,
        org_id: OptionalNullable[str] = UNSET,
    ...
    def get_permission_audit_stats_api_v1_audit_logs_permissions_stats_get(
        self,
        *,
        org_id: OptionalNullable[str] = UNSET,
        start_date: OptionalNullable[datetime] = UNSET,
    ...
    async def get_permission_audit_stats_api_v1_audit_logs_permissions_stats_get_async(
        self,
        *,
        org_id: OptionalNullable[str] = UNSET,
        start_date: OptionalNullable[datetime] = UNSET,
