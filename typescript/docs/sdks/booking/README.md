...
async function run() {
  const result = await linebundle.booking.create({
    placeId: 155472,
    title: "<value>",
...
import { bookingCreate } from "@linebundle-sdk/ts/funcs/booking-create.js";
...
async function run() {
  const res = await bookingCreate(linebundle, {
    placeId: 155472,
    title: "<value>",
    startDt: new Date("2026-07-29T07:30:38.034Z"),
    endDt: new Date("2025-07-25T01:27:35.680Z"),
  ...
  if (res.ok) {
    ...
    console.log("bookingCreate failed:", res.error);
  }
}
