...
* [getById](#getbyid) - Get Booking By Id
* [delete](#delete) - Delete Booking
* [checkAvailability](#checkavailability) - Check Availability
* [getPlaceSchedule](#getplaceschedule) - Get Place Schedule
...
async function run() {
  const result = await linebundle.bookings.list({});
...
import { bookingsList } from "@linebundle-sdk/ts/funcs/bookings-list.js";
...
async function run() {
  const res = await bookingsList(linebundle, {});
  if (res.ok) {
...
async function run() {
  const result = await linebundle.bookings.getById({
    bookingId: 390139,
  });
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { bookingsGetById } from "@linebundle-sdk/ts/funcs/bookings-get-by-id.js";
...
async function run() {
  const res = await bookingsGetById(linebundle, {
    bookingId: 390139,
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("bookingsGetById failed:", res.error);
  }
}
...
async function run() {
  await linebundle.bookings.delete({
    bookingId: 445945,
  });
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { bookingsDelete } from "@linebundle-sdk/ts/funcs/bookings-delete.js";
...
async function run() {
  const res = await bookingsDelete(linebundle, {
    bookingId: 445945,
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await linebundle.bookings.checkAvailability({
    placeId: 192292,
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { bookingsCheckAvailability } from "@linebundle-sdk/ts/funcs/bookings-check-availability.js";
...
async function run() {
  const res = await bookingsCheckAvailability(linebundle, {
    placeId: 192292,
    startDt: new Date("2024-11-25T20:07:13.686Z"),
    endDt: new Date("2025-05-23T08:23:07.188Z"),
  });
  if (res.ok) {
    ...
    console.log("bookingsCheckAvailability failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.bookings.getPlaceSchedule({
    placeId: 892109,
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { bookingsGetPlaceSchedule } from "@linebundle-sdk/ts/funcs/bookings-get-place-schedule.js";
...
async function run() {
  const res = await bookingsGetPlaceSchedule(linebundle, {
    placeId: 892109,
    startDate: new Date("2026-02-03T15:48:07.831Z"),
    endDate: new Date("2026-05-25T20:30:02.025Z"),
  });
  if (res.ok) {
    ...
    console.log("bookingsGetPlaceSchedule failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.bookings.update({
    bookingId: 623513,
    body: {
      title: "<value>",
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { bookingsUpdate } from "@linebundle-sdk/ts/funcs/bookings-update.js";
...
async function run() {
  const res = await bookingsUpdate(linebundle, {
    bookingId: 623513,
    body: {
      title: "<value>",
      startDt: new Date("2024-03-03T11:02:27.501Z"),
  ...
  if (res.ok) {
    ...
    console.log("bookingsUpdate failed:", res.error);
  }
}
