...
* [getCount](#getcount) - Get Message Count
* [markRead](#markread) - Mark Messages As Read
* [getUnreadCount](#getunreadcount) - Get Unread Count
...
async function run() {
  const result = await linebundle.chatMessages.list({
...
import { chatMessagesList } from "@linebundle-sdk/ts/funcs/chat-messages-list.js";
...
async function run() {
  const res = await chatMessagesList(linebundle, {
    roomId: "2773f0dc-6191-47ed-a27a-49aff3a1ab99",
  });
  if (res.ok) {
    ...
    console.log("chatMessagesList failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.chatMessages.send({
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { chatMessagesSend } from "@linebundle-sdk/ts/funcs/chat-messages-send.js";
...
async function run() {
  const res = await chatMessagesSend(linebundle, {
    roomId: "f85470e3-0f24-416a-9013-8647e7ec4832",
    body: {
      content: "<value>",
    },
  ...
  if (res.ok) {
    ...
    console.log("chatMessagesSend failed:", res.error);
  }
}
...
async function run() {
  await linebundle.chatMessages.delete({
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { chatMessagesDelete } from "@linebundle-sdk/ts/funcs/chat-messages-delete.js";
...
async function run() {
  const res = await chatMessagesDelete(linebundle, {
    messageId: "9692ae2c-4af5-45e5-9b83-986ead643c65",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("chatMessagesDelete failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.chatMessages.getCount({
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { chatMessagesGetCount } from "@linebundle-sdk/ts/funcs/chat-messages-get-count.js";
...
async function run() {
  const res = await chatMessagesGetCount(linebundle, {
    roomId: "2f590a19-f2f8-4d99-af96-d6a575274d0c",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("chatMessagesGetCount failed:", res.error);
  }
}
...
async function run() {
  await linebundle.chatMessages.markRead({
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { chatMessagesMarkRead } from "@linebundle-sdk/ts/funcs/chat-messages-mark-read.js";
...
async function run() {
  const res = await chatMessagesMarkRead(linebundle, {
    roomId: "b9e8afae-f469-4371-8366-b4d017f6860b",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("chatMessagesMarkRead failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.chatMessages.getUnreadCount({
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { chatMessagesGetUnreadCount } from "@linebundle-sdk/ts/funcs/chat-messages-get-unread-count.js";
...
async function run() {
  const res = await chatMessagesGetUnreadCount(linebundle, {
    roomId: "09a622b3-5e49-4382-a4cb-5455f4b35a73",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("chatMessagesGetUnreadCount failed:", res.error);
  }
}
