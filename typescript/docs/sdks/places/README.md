...
async function run() {
  const result = await linebundle.places.list({});
...
import { placesList } from "@linebundle-sdk/ts/funcs/places-list.js";
...
async function run() {
  const res = await placesList(linebundle, {});
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("placesList failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.places.create({
    title: "<value>",
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { placesCreate } from "@linebundle-sdk/ts/funcs/places-create.js";
...
async function run() {
  const res = await placesCreate(linebundle, {
    title: "<value>",
    description: "around wildly biodegrade",
    visibility: 252569,
    placeType: "online_meeting",
  ...
  if (res.ok) {
    ...
    console.log("placesCreate failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.places.get({
    placeId: 95579,
  });
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { placesGet } from "@linebundle-sdk/ts/funcs/places-get.js";
...
async function run() {
  const res = await placesGet(linebundle, {
    placeId: 95579,
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("placesGet failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.places.update({
    placeId: 241943,
    body: {
      title: "<value>",
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { placesUpdate } from "@linebundle-sdk/ts/funcs/places-update.js";
...
async function run() {
  const res = await placesUpdate(linebundle, {
    placeId: 241943,
    body: {
      title: "<value>",
      description: "swanling replacement monster amend",
  ...
  if (res.ok) {
    ...
    console.log("placesUpdate failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.places.delete({
    placeId: 54419,
  });
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { placesDelete } from "@linebundle-sdk/ts/funcs/places-delete.js";
...
async function run() {
  const res = await placesDelete(linebundle, {
    placeId: 54419,
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("placesDelete failed:", res.error);
  }
}
