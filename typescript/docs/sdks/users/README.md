...
* [getCurrentProfile](#getcurrentprofile) - Get Current User Profile
* [getAvatar](#getavatar) - Get Avatar
* [deleteAvatar](#deleteavatar) - Delete Avatar
* [getAvatarById](#getavatarbyid) - Get User Avatar
...
async function run() {
  const result = await linebundle.users.search({});
...
import { usersSearch } from "@linebundle-sdk/ts/funcs/users-search.js";
...
async function run() {
  const res = await usersSearch(linebundle, {});
  if (res.ok) {
...
async function run() {
  const result = await linebundle.users.getCurrentProfile();
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { usersGetCurrentProfile } from "@linebundle-sdk/ts/funcs/users-get-current-profile.js";
...
async function run() {
  const res = await usersGetCurrentProfile(linebundle);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("usersGetCurrentProfile failed:", res.error);
  }
}
...
async function run() {
  await linebundle.users.getAvatar();
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { usersGetAvatar } from "@linebundle-sdk/ts/funcs/users-get-avatar.js";
...
async function run() {
  const res = await usersGetAvatar(linebundle);
  if (res.ok) {
    const { value: result } = res;
    
  } else {
    console.log("usersGetAvatar failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.users.deleteAvatar();
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { usersDeleteAvatar } from "@linebundle-sdk/ts/funcs/users-delete-avatar.js";
...
async function run() {
  const res = await usersDeleteAvatar(linebundle);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("usersDeleteAvatar failed:", res.error);
  }
}
...
async function run() {
  const result = await linebundle.users.getAvatarById({
    userId: "<id>",
  });
...
```typescript
import { LinebundleCore } from "@linebundle-sdk/ts/core.js";
import { usersGetAvatarById } from "@linebundle-sdk/ts/funcs/users-get-avatar-by-id.js";
...
async function run() {
  const res = await usersGetAvatarById(linebundle, {
    userId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("usersGetAvatarById failed:", res.error);
  }
}
