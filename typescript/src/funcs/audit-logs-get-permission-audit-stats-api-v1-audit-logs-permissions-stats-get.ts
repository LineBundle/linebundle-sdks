 ...
 */
export function auditLogsGetPermissionAuditStatsApiV1AuditLogsPermissionsStatsGet(
  client: SDKCore,
  request?:
...
> {
  ...
  const path = pathToFunc("/api/v1/audit-logs/permissions/stats")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PermissionAuditStats$inboundSchema),
