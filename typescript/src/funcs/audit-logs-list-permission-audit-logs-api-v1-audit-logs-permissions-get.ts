 ...
 */
export function auditLogsListPermissionAuditLogsApiV1AuditLogsPermissionsGet(
  client: SDKCore,
  request?:
...
> {
  ...
  const path = pathToFunc("/api/v1/audit-logs/permissions")();
  ...
  const context = {
    ...
    operationID: "list_permission_audit_logs_api_v1_audit_logs_permissions_get",
    oAuth2Scopes: null,
