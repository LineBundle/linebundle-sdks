 ...
 */
export function authContextsGet(
...
> {
  const path = pathToFunc("/api/v1/auth/context")();
  ...
  const context = {
    ...
    operationID: "get_auth_context_api_v1_auth_context_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserContextResponse$inboundSchema),
