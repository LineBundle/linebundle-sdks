 ...
 */
export function automationRulesCreateRuleApiV1AutomationRulesPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateRuleRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.RuleResponse$inboundSchema),
