 ...
 */
export function automationRulesCronHealthCheckApiV1AutomationApiV1AutomationCronHealthGet(
  client: SDKCore,
...
> {
  const path = pathToFunc("/api/v1/automation/api/v1/automation/cron/health")();
