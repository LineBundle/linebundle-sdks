 ...
 */
export function customRolesGetMyPermissions(
  client: LinebundleCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.PermissionResponse>,
    | LinebundleError
...
> {
  const path = pathToFunc("/api/v1/roles/me/permissions")();
  ...
  const context = {
    ...
    operationID: "get_my_permissions_endpoint_api_v1_roles_me_permissions_get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.PermissionResponse$inboundSchema)),
