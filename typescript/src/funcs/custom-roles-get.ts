 ...
 */
export function customRolesGet(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetRoleEndpointApiV1RolesRoleIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "get_role_endpoint_api_v1_roles__role_id__get",
    oAuth2Scopes: null,
