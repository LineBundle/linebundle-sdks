 ...
 * Create Event
 */
export function eventCreateEventApiV1EventPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.BodyCreateEventApiV1EventPost$outboundSchema, value),
  ...
  appendForm(body, "request", payload.request);
  ...
  const context = {
    ...
    operationID: "create_event_api_v1_event_post",
    oAuth2Scopes: null,
