 ...
 */
export function eventGetEventListApiV1EventGet(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetEventListApiV1EventGetRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/event")();
  ...
  const context = {
    ...
    operationID: "get_event_list_api_v1_event_get",
    oAuth2Scopes: null,
