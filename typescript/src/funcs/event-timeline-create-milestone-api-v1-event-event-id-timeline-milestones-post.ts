 ...
 */
export function eventTimelineCreateMilestoneApiV1EventEventIdTimelineMilestonesPost(
  client: SDKCore,
  security:
...
> {
  ...
  appendForm(body, "request", payload.body.request);
  ...
  const path = pathToFunc("/api/v1/event/{event_id}/timeline/milestones")(
    pathParams,
  );
    ...
    [
      {
        ...
        type: "http:bearer",
        value: security?.permissionDependency,
      },
    ],
  );
  ...
  const context = {
    ...
    operationID:
      "create_milestone_api_v1_event__event_id__timeline_milestones_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.EventRead$inboundSchema),
