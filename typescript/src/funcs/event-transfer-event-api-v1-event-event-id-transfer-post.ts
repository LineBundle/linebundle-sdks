 ...
 *     - 404: Event not found
 */
export function eventTransferEventApiV1EventEventIdTransferPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .TransferEventApiV1EventEventIdTransferPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/event/{event_id}/transfer")(pathParams);
  ...
  const context = {
    ...
    operationID: "transfer_event_api_v1_event__event_id__transfer_post",
    oAuth2Scopes: null,
