 ...
 * Update Cover
 */
export function eventUpdateCoverApiV1EventEventIdCoverPatch(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateCoverApiV1EventEventIdCoverPatchRequest$outboundSchema,
        value,
      ),
  ...
  if (payload.body.theme !== undefined) {
    appendForm(body, "theme", payload.body.theme);
  }
  ...
  const path = pathToFunc("/api/v1/event/{event_id}/cover")(pathParams);
  ...
  const context = {
    ...
    operationID: "update_cover_api_v1_event__event_id__cover_patch",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.EventRead$inboundSchema),
