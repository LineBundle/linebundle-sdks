 ...
 */
export function integrationHandleOrgRemoved(
...
> {
  const path = pathToFunc("/api/v1/integration/org-removed")();
  ...
  const context = {
    ...
    operationID: "handle_org_removed_api_v1_integration_org_removed_post",
    oAuth2Scopes: null,
