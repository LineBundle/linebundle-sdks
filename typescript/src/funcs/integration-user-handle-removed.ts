 ...
 */
export function integrationUserHandleRemoved(
...
> {
  const path = pathToFunc("/api/v1/integration/user-removed")();
  ...
  const context = {
    ...
    operationID: "handle_user_removed_api_v1_integration_user_removed_post",
    oAuth2Scopes: null,
