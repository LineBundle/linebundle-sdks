 ...
 */
export function integrationsHandleOrgCreated(
...
> {
  const path = pathToFunc("/api/v1/integration/org-created")();
  ...
  const context = {
    ...
    operationID: "handle_org_created_api_v1_integration_org_created_post",
    oAuth2Scopes: null,
