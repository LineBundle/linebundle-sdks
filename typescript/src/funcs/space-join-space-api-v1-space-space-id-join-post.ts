 ...
 *         - 500: Server error
 */
export function spaceJoinSpaceApiV1SpaceSpaceIdJoinPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.JoinSpaceApiV1SpaceSpaceIdJoinPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/space/{space_id}/join")(pathParams);
  ...
  const context = {
    ...
    operationID: "join_space_api_v1_space__space_id__join_post",
    oAuth2Scopes: null,
