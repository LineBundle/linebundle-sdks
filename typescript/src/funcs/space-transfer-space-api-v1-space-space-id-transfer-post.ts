 ...
 *         - 500: Server error
 */
export function spaceTransferSpaceApiV1SpaceSpaceIdTransferPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations
          .TransferSpaceApiV1SpaceSpaceIdTransferPostRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/space/{space_id}/transfer")(pathParams);
  ...
  const context = {
    ...
    operationID: "transfer_space_api_v1_space__space_id__transfer_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TransferSpaceResponse$inboundSchema),
