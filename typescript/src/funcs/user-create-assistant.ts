 ...
 */
export function userCreateAssistant(
...
> {
  const path = pathToFunc("/api/v1/user/assistant")();
  ...
  const context = {
    ...
    operationID: "create_assistant_api_v1_user_assistant_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AssistantResponse$inboundSchema),
