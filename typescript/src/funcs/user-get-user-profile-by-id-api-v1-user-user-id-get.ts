 ...
 */
export function userGetUserProfileByIdApiV1UserUserIdGet(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetUserProfileByIdApiV1UserUserIdGetRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/api/v1/user/{user_id}")(pathParams);
  ...
  const context = {
    ...
    operationID: "get_user_profile_by_id_api_v1_user__user_id__get",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserProfileResponse$inboundSchema),
