 ...
 */
export function userUploadAvatarApiV1UserMeAvatarPost(
  client: SDKCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        models.BodyUploadAvatarApiV1UserMeAvatarPost$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "upload_avatar_api_v1_user_me_avatar_post",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AvatarUploadResponse$inboundSchema),
