...
/** @internal */
export const CreateRoleEndpointApiV1RolesPostRequest$outboundSchema:
  z.ZodMiniType<
    CreateRoleEndpointApiV1RolesPostRequest$Outbound,
...
export function createRoleEndpointApiV1RolesPostRequestToJSON(
  createRoleEndpointApiV1RolesPostRequest:
    CreateRoleEndpointApiV1RolesPostRequest,
): string {
  return JSON.stringify(
    CreateRoleEndpointApiV1RolesPostRequest$outboundSchema.parse(
      createRoleEndpointApiV1RolesPostRequest,
    ),
  );
}
