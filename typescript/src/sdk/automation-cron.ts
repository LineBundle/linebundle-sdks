...
import { automationCronHealthCheck } from "../funcs/automation-cron-health-check.js";
import { automationCronTriggerScheduled } from "../funcs/automation-cron-trigger-scheduled.js";
...
export class AutomationCron extends ClientSDK {
  ...
  async triggerScheduled(
    ...
    return unwrapAsync(automationCronTriggerScheduled(
      this,
      request,
      options,
    ));
  ...
  async healthCheck(
    ...
    return unwrapAsync(automationCronHealthCheck(
      this,
      options,
    ));
  }
